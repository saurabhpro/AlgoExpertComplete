...
class Q8_ProductSumTest {
    ...
    void productSum() {
        ...
        // 7 + 12 + 2 * 10
        // 39
        final var productSum = Q8_ProductSum.productSum(List.of(5, 2, List.of(7, -1), List.of(3, List.of(6, -4), 1)));
    ...
    void productSum2() {
        ...
        final var productSum = Q8_ProductSum.productSum(m);
